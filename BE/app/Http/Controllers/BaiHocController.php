...
class BaiHocController extends Controller
{
    public function indexPublic(Request $request): JsonResponse
    {
        ...
        // Đồng bộ với BaiHoc: TRANG_THAI_HOAT_DONG = hiển thị học viên.
        $query = BaiHoc::query()
            ->with([
        ...
        if (isset($input['tim_kiem'])) {
            ...
            // đảm bảo điều kiện trạng thái hoạt động ở ngoài luôn được áp dụng.
    ...
    {
        if ((int) $baiHoc->trang_thai !== BaiHoc::TRANG_THAI_HOAT_DONG) {
            abort(404);
        }
